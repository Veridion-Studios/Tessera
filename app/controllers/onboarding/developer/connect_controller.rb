    ...
    class ConnectController < BaseController
      ...
      def start
        ...
        account_link = Stripe::AccountLink.create({
          ...
          refresh_url: "#{ENV["APP_HOST"]}#{onboarding_developer_connect_refresh_path}",
          return_url:  "#{ENV["APP_HOST"]}#{onboarding_developer_connect_refresh_path}",
      ...
      def refresh
        if profile.stripe_connect_id.present?
          ...
          if account.charges_enabled && account.details_submitted
            ...
            redirect_to onboarding_developer_complete_path
          else
